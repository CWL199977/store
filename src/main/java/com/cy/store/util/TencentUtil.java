...
public class TencentUtil {
    // 此处填写的存储桶名称
    private static final String bucketName = "chang-1312945972";
    //secretId
    private static final String SecretId = "AKIDkKdhTyCAqFNFqBG4cttc4GAnAF3aqqZ0";
    //SecretKey
    private static final String SecretKey = "C7l8D2btue8LGuIODVYKp2ye29zZsugC";
